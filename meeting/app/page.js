...
export default function Home() {
  ...
  const handleJoin = () => {
    ...
    router.push(`/meets/${meetingId}?name=${encodeURIComponent(name)}`);
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      <div className="p-8 bg-gray-800/60 rounded-2xl border border-gray-700 w-80 shadow-2xl">
        ...
        <button
          onClick={handleJoin}
          className="mt-5 w-full py-3 bg-blue-800 hover:bg-blue-900 rounded-lg font-medium shadow-lg transition">
          Join Meeting
        </button>
      </div>
    </div>
